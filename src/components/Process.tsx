    ...
    <section id="process" className="py-32 bg-black relative">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-20">
          <h2 className="text-brand-blue font-bold tracking-widest uppercase text-sm mb-4">How It Works</h2>
          <h3 className="text-4xl md:text-5xl font-heading font-black uppercase text-white tracking-tighter leading-none">
            Effortless <span className="text-zinc-600">Perfection</span>
          </h3>
        </div>
        ...
        <div className="relative">
          ...
          <div className="grid md:grid-cols-3 gap-12 relative z-10">
            {steps.map((step, i) => (
              ...
              >
                <div className="w-24 h-24 rounded-full bg-black border-2 border-white/10 glass flex items-center justify-center mb-8 relative z-10 group-hover:border-blue-500 transition-colors duration-500 shadow-[0_0_30px_rgba(0,0,0,0.5)] group-hover:shadow-[0_0_40px_rgba(0,118,255,0.3)]">
                  <span className="text-4xl font-heading font-black text-transparent bg-clip-text bg-gradient-to-br from-white to-zinc-600 group-hover:from-blue-400 group-hover:to-blue-600 transition-all duration-500">
                    {step.num}
                  </span>
                </div>
